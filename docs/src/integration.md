...
For more information on debugger macros see the [Macros](./macros.md) and [Functions & Classes](./classes.md) section, or view the [Debugger Client](./debugger.md) documentation.