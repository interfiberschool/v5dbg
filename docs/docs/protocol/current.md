...
### `DEBUGGER_MESSAGE_BREAK_INVOKED` :octicons-checklist-24:{title="This message uses subarguments in the data field"}

This message is sent to signal that the debug server has suspended execution of the program over a breakpoint being tripped.
